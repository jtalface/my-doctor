      ...
      <div className={styles.modal}>
        ...
        {(callState === 'active' || callState === 'ringing' || callState === 'connecting') && (
          <div className={styles.controls}>
            ...
            >
              {isMuted ? '🔇' : '🎤'}
              <span>{isMuted ? t('call_unmute') : t('call_mute')}</span>
            </button>
            ...
            <button
              ...
              title={isSpeaker ? t('call_earpiece') : t('call_speaker')}
            >
              {isSpeaker ? '🔊' : '🔈'}
